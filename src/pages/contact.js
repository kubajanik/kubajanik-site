  ...
  return (
    <Layout>
      ...
      <section className="py-12">
        <form className="mx-auto max-w-3xl px-8 grid grid-cols-2 gap-4">
          ...
          />
          <textarea
            className="p-3 col-span-2 text-gray-600 rounded border border-gray-400 border-solid placeholder-gray-600 focus:border-green-500 focus:outline-none transition-colors duration-500"
            rows="10"
            placeholder="Wprowadź twoją wiadomość"
          ></textarea>
          <button
            className="h-10 p-3 leading-none bg-green-500 rounded col-span-2 text-white font-bold hover:bg-green-700 transition-colors duration-500"
            type="submit"
          >
            Wyślij
          </button>
